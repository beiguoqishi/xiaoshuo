...
<div class="head-bar">
    <div class="head-bar-content relative">
        ...
        <ul class="head-bar-tool">
            ...
            <li class="sep">|</li>
            <li class="head-bar-tool-feedback"><a href="http://feedback.hao123.com/?catalog_id=8">意见反馈</a></li>
            <li class="sep">|</li>
...
<div class="head-nav">
    <div class="head-nav-logo">
        ...
        <form method="get" class="baidu-search-con" role="search" action="http://www.baidu.com/s" target="_blank"
              id="baidu_search_form">
            <fieldset>
                <legend class="hide-offscreen">百度搜索</legend>
                <ul class="search-text clearfix" id="search_list">
                    <li class="first selected"><a search-des="web" href="http://www.baidu.com/s?tn=sitehao123"
                                                  target="_blank">网页</a></li>
                    <li><a search-des="video" href="http://video.baidu.com/v?sc=hao123" target="_blank">视频</a>
                    </li>
                    <li class="mp3"><a search-des="mp3"
                    ...
                    <li><a search-des="tieba" href="http://tieba.baidu.com/f?kw=aaa&sc=hao123"
                           target="_blank">贴吧</a></li>
                    <li><a search-des="zhidao" href="http://zhidao.baidu.com/q?tn=ikaslist&ct=17&sc=hao123&rn=20"
                           target="_blank">知道</a></li>
                    <li><a search-des="news" href="http://news.baidu.com/ns?tn=news&sc=hao123"
